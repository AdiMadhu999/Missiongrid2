              ...
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-5 space-y-5">
                ...
                <div className="text-xs space-y-3">
                  <p className="text-slate-400 leading-normal">
                    This triggers a live sweep over all active student documents. If a student has no submitted mission report for yesterday (excluding manual overrides), their consecutive missed missions counter is incremented. Upon reaching 10 missed missions, premium access is automatically revoked and logged in the <strong>premium_history</strong> and <strong>security_history</strong> collections.
                  </p>
                            ...
                            <div key={res.studentId} className="flex justify-between items-center p-2 rounded bg-slate-950 border border-slate-900">
                              ...
                              <div className="text-right">
                                ...
                                {res.missedCount !== undefined && (
                                  <span className="text-[9px] text-slate-500 block">Consecutive Missed: {res.missedCount}/10</span>
                                )}
                              </div>
                            </div>
                          ))
