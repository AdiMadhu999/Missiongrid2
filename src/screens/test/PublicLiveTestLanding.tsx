            ...
            <div className={isScheduledInFuture ? "pt-8 space-y-6" : "space-y-6"}>
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1 font-semibold">
                  {userProfile ? `Logged in as ${userProfile.name}` : "You are participating as a public guest."}
                </p>
                {!userProfile && (
                  <p className="text-[10px] text-emerald-400 font-bold mt-2">
                    ✅ No login required to attempt. You will be able to see your evaluation and rank.
                  </p>
                )}
              </div>
