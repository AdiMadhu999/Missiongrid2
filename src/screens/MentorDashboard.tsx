...
import { 
  ...
  User as UserIcon, Trophy, Eye, EyeOff, Lock
} from 'lucide-react';
...
export default function MentorDashboard() {
  ...
  return (
    <div className="p-4 md:max-w-4xl md:mx-auto bg-gradient-to-tr from-slate-100 via-slate-50 to-indigo-50/40 min-h-screen pb-32 md:pb-8 space-y-6 font-sans">
      ...
      <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
             ...
             <button 
               onClick={() => navigate('/app/doubt?filter=private')} 
               className="flex flex-col justify-between items-start p-5 bg-gradient-to-tr from-fuchsia-50/40 via-white to-white rounded-3xl border border-fuchsia-100/70 shadow-xs hover:border-fuchsia-300 hover:shadow-fuchsia-100/55 hover:scale-[1.02] active:scale-[0.98] transition-all duration-250 group min-h-[110px] text-left"
             >
                <div className="w-10 h-10 bg-fuchsia-50 text-fuchsia-600 rounded-xl flex items-center justify-center group-hover:bg-fuchsia-600 group-hover:text-white transition-all duration-250 mb-4 shadow-xs">
                    <Lock size={20}/>
                </div>
                <div>
                    <p className="font-black text-slate-900 text-sm group-hover:text-fuchsia-950 transition-colors">Private Doubts</p>
                    <p className="text-[10px] text-fuchsia-650 font-bold uppercase tracking-tight mt-0.5">Doubt Rooms</p>
                </div>
             </button>
          </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-2">
          ...
          <button 
            onClick={() => navigate('/app/study-material-creator')} 
            className="p-3 bg-gradient-to-tr from-cyan-50 to-cyan-100/50 border border-cyan-200/50 text-cyan-950 font-black text-xs rounded-2xl hover:bg-cyan-100 hover:border-cyan-300 active:scale-95 transition-all text-center uppercase tracking-tight flex flex-col items-center justify-center gap-1.5 shadow-xs"
          >
