...
export const DEFAULT_LIVE_HOST = window.location.origin.includes('localhost') || window.location.origin.includes('-dev-') 
  ? 'https://mission-selection-43729399220.asia-south1.run.app' 
